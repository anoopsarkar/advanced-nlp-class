...
There will be a poster session at the SFU Burnaby campus on {{ site.hwdates[5].deadline }}. 
...
code for your project in your GitLab repository `advnlpclass-{{ site.semcode }}-g-GROUP`.

Put all your project files into the directory `project` in your
GitLab repository.

Make sure you have a `setup.py` or `requirements.txt` file for your project
...
Please read this [guide to presenting your work](assets/cached/cs224u-2019-presenting.pdf). Also available is a [video tutorial covering the same material](https://www.youtube.com/watch?v=WXLb4h2A724).
